...
export const jobs = sqliteTable("jobs", {
  ...
  plannedHeadcount: integer("planned_headcount").notNull().default(1),
  keywords: text("keywords").notNull(),
  scoreWeights: text("score_weights").notNull().default('{"experience":30,"professional":30,"stability":15,"education":10,"business":15}'),
  description: text("description").notNull(),
  status: text("status").notNull(),
  currentBatchId: text("current_batch_id").notNull().default(""),
  recruitmentBatches: text("recruitment_batches").notNull().default("[]"),
...
export const candidates = sqliteTable("candidates", {
  ...
  recruitmentBatchId: text("recruitment_batch_id").notNull().default(""),
  ...
  stageRecommendation: text("stage_recommendation").notNull().default("待定"),
  ...
  interviewStage: text("interview_stage").notNull().default("推荐"),
